...
<!--		<div class="navbar-header">
		...
		<div class="container theme-showcase" role="main">
			...
			<p>Please feel free to send us any queries relating to the content of our site or any suggestions for improvement. We greatly appreciate any feedback.  <em>Kilkenny</em> hurling followers and supporters of any other counties are welcome to pass comments and make recommendations. Kilkenny is also a great place to visit so feel free to browse any of the sites in our links section.<em>Thank you for visiting our site</em> and remember to come back and view our site regularly for updates.</p>
		...
		<br><br><br>
				...
				<H4><strong>Send us a web query</strong></H4>
				
				<legend>Query Form</legend> 

	  <form class="query-form" action="formSubmitted.php" name="queryForm" onsubmit="return(formValidate());" novalidate>
        ...
        <input type="text" id="inputQuery" name="inputQuery" class="form-control" placeholder="Enter your query here" required>
        ...
        <div class="checkbox">
			<label>
            <input type="checkbox" name="newsletter" value="newsletter-yes"> Check this if you wish
		...
		<button class="btn btn-lg btn-primary btn-block" type="submit">Submit</button>
			...
			<div class="col-sm-12 col-md-4">
				...
				<br><br>
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d92068.76175324494!2d-7.278979904265519!3d52.67110108506178!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sie!4v1448567035388" width="220" height="450" style="border:none"  allowfullscreen></iframe>
				<br><br><br>
				
				
				<video poster="images/kilkenny_castle.jpe" width="220" height="320" CONTROLS PRELOAD>
				<source src="video/visit_kilkenny.mp4" type='video/mp4' />
				
				<p>A video of Kilkenny City</p>
				</video>
			...
			<div class="article column2">
				...
				<div>
			<br><p>
			<H4><strong>Contact by post/phone/email</strong></H4></P>
				<form class="form" id="query" name="name">
				<fieldset>
				<legend>Details</legend>
			<strong>Please contact us by email, post or ring the number below</strong> 
			<p>Black & Amber<br>37 High Street<br>Kilkenny<br>Ireland<br>051-422802</p>
			
			
			<p><strong>Email: </strong><a href="mailto:noelgrace@gmail.com">noelgrace@gmail.com</a></P>
		
		 </div>
		<br><br><br><br>		
				<form action="action_page.php" method="get">
				<label for="hurler?"><strong>Who is the best Kilkenny hurler?</strong></label><br />
				
<div class="dropdown">
		  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Best Hurler
		  <span class="caret"></span></button>
		  <ul class="dropdown-menu">
			<li><a href="#">Richie Hogan</a></li>
			<li><a href="#">TJ Reid</a></li>
			<li><a href="#">Kieran Joyce</a></li>
			<li><a href="#">Michael Fennelly</a></li>
			</ul>
		</div>				
				...
				<label for="comments"><strong>Post a Message to our forum:</strong></label><br>
				<p><textarea name="message" id="comments" rows="10" cols="25">Kilkenny are the 2015 All-Ireland Champions.
				</textarea></p><br>
				<br>
				
				<form action="">
				<input type="checkbox" name="certify" value="certify">  Check this box to declare that the messsage posted will not include any offensive language
				or any text that may be 
				considered bullying or intimidation!<br></form>
				<br>
				
				
				<form>
				<input type="submit" value="Submit" onMouseDown='DisplayMessage("Your message will be posted to our forum once we review the comments!")';>
				</form>
				<div id="Msg"> Click the button!
				</div>
				<br><br><br><br>
