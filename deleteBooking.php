...
<html lang="en">
	...
	<meta name="author" content="Noel Grace">
		<title>Black & Amber - Delete Bookings</title>
...
<!--		<div class="navbar-header">
	...
	following booking: <br>
	
	<fieldset>
		<legend>Delete</legend>			
		<form class="query-form" action="bookingDeleted.php" 
		...
		<label for="oldClass">Match:</label>
		...
		<button class="btn btn-lg btn-danger" type="submit" name="booking_id" 
		value="<?php echo $bookingID;?>">Delete Booking</button>
