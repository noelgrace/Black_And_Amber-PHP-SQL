...
<!-- Start hiding JavaScript statements
 ...
 function ValidateAge(age){
		if (age >= 18) {
		window.alert("Welcome! to Black & Amber.");
		}
		else {
			window.alert("You must be at least 18 years of age to enter this website, sorry");
			}
	}
...
//Link C
 ...
 document.getElementById('tenthLink').innerHTML = msgInput;
	...
	<META name="description" content="Kilkenny hurling">
	...
	// End hiding JavaScript statements -->
		...
		<nav class="navbar navbar-inverse navbar" role="navigation">
            <div class="container">
                <ul class="nav navbar-nav">	
                    <li class="active"><a href="index.php" data-toggle="tooltip" title="Home Page!">Home</a></li>
		...
		<div class="container theme-showcase" role="main">
			...
			<p> <em>Black & Amber</em> is a website dedicated to Kilkenny hurling greats during the <em>Brian Cody</em> era of 1999 to present date.
			The current <a href="kilkenny.php" class="text link">Kilkenny Team</a> team which includes some of the greatest Kilkenny hurlers of all time such as <a href="richie.php" class="text link">Richie Hogan</a>, Michael Fennelly and TJ Reid is managed by the legendary <em>Brian Cody</em>. This team has been described by many leading GAA pundits on <strong>The Sunday Game</strong> such as <em>Ger Loughnane, Liam Sheedy, Cyrill Farrell and Donal Óg Cusack</em> as the greatest team of all time.
			Kilkenny have won an unprecedented 36 <strong>All-Ireland</strong> Senior Titles including an historic four in a row <strong>2006-2009</strong> and they lead the roll of honour.</p>
			
			<h2>2015 Season</h2>
			
			<p> <em>Kilkenny</em> celebrated winning their 36<sup>th</sup> <em>All-Ireland</em> title in 2015 another monumental achievement for what has been described as the <em>Greatest Team of all Time</em>. </p>
			...
			<h2>All Stars</h2>
				...
				<br><br>
				<figure>
					<img src="images/all_stars.jpg" alt="Kilkenny All-Stars" title="Kilkenny All-Stars" />
					<figcaption>Kilkenny All-Stars</figcaption>
				</figure>
				
				<br><br><br>
				
				<figure>
					<img src="images/stage_resized.jpg" alt="stage" title="stage" />
					<figcaption>All-Star Stage</figcaption>
				</figure>
				<br><br><br>
				
				<video poster="images/all_stars.jpg" width="220" height="320" CONTROLS PRELOAD>
				<source src="video/all_stars.mp4" type='video/mp4' />
				
				<p>A video of the all-stars</p>
				 </video>
			...
			<div class="article column2">
				<br><p>Seven Kilkenny hurlers won a place on the 2015 All Stars Team. Well done to Paul Murphy, Joey Holden, Cillian Buckley, Michael Fennelly, Richie Hogan, T J Reid and Ger Aylward. It was first time awards for Joey and Ger.</p>
				
				<p>The GAA, GPA and Opel presented 15 hurlers for the  2015 season with All-Star hurling awards. Recent All-Ireland champions Kilkenny led the haul with a magnificent 7 awards.All-Ireland finalists Galway fared very well obtaining 4 awards.
				Waterford’s strong 2015 showing saw them earn league honours before reaching a Munster final and All-Ireland semi-final. This form was awarded in the Deise claiming 3 All-Star awards including the <strong>Young Hurler of the Year</strong> which went to <em>Tadhg De Burca</em>. 
				Munster champions Tipperary claimed just one award for 2015 despite their form in winning the <strong>Munster Championship</strong>.</p> 
				
				<p>The award ceremony took place on Friday November 6 2015 in the National Convention Centre in Dublin.</p>
			</div>
			</div>
