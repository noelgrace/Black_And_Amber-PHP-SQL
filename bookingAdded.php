...
<html lang="en">
	...
	<meta name="author" content="Noel Grace">
		<title>Black & Amber -  Booking Added</title>
...
<!--		<div class="navbar-header">
			...
			<h1>Confirmation of New Booking</h1>
		...
		$sql="INSERT INTO bookings (match_id, user_id)
		VALUES('$_REQUEST[selectMatch]','$userID')";

		if ($conn->query($sql) === TRUE) {
			echo "Booking created successfully."; 
			echo "<br><a href='bookings.php'>View your bookings.</a>";
		} else {
