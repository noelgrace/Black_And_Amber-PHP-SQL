...
<html lang="en">
	...
	<meta name="author" content="Noel Grace">
		<title>Black & Amber -  Booking Edited</title>
...
<!--		<div class="navbar-header">
    ...
    <header class="jumbotron">
			...
			<h1>Confirmation of Booking Edited</h1>
		...
		$sql="UPDATE bookings SET match_id='$_REQUEST[selectMatch]' 
		WHERE booking_id=$bookingID";

		if ($conn->query($sql) === TRUE) {
			echo "Booking amended successfully.<br>";
			echo "<a href='bookings.php'>View your bookings.</a>";
		} else {
